...
//	public final int TWINBIKE = 2;
	...
	public boolean match(Bike bike) {
		...
		if (bike.lisencePlate != null && !bike.lisencePlate.equals("") && !this.lisencePlate.contains(bike.lisencePlate)) {
			return false;
		}
		if (bike.manuafaturingDate != null && !this.manuafaturingDate.equals(bike.manuafaturingDate)) {
			return false;
		}
		if (bike.manuafaturer != null && !bike.manuafaturer.equals("") && !this.manuafaturer.contains(bike.manuafaturer)) {
			return false;
		}
